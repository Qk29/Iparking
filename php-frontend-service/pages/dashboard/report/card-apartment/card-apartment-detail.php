...
<div class="container ms-3">
  <h4 class="mb-4">Báo cáo chi tiết thẻ theo căn hộ (<?php echo count($cardLists); ?>)</h4>
   ...
   <div class="row mb-3">
    ...
    <table class="table table-bordered table-hover text-center">
      ...
      <tbody>
            <?php $stt =1; foreach($cardLists as $card) : ?>
                <tr class="card-row" 
                    data-customer-group-id="<?= $card['CustomerGroupID'] ?? '' ?>"
                    data-card-group-id="<?= $card['CardGroupID'] ?? '' ?>"
                    data-apartment-group-id="<?= $card['CompartmentId'] ?? '' ?>">
                    ...
                    <td class="plate"><?= $card['Plate1'] ?></td>
                    <td><?= $card['DateRegister'] ?></td>
                    <td><?= $card['DateRelease'] ?></td>
                    <td><?= $card['ExpireDate'] ?></td>
                    <td><?= $card['ImportDate'] ?></td>
